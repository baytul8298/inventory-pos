        ...
        <div class="modal-content">
            ...
            <form class="form" id="form" action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        <label for="short_description" class="form-label fw-semibold">Duaration:  <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <input type="text" id="duration" aria-label="First name" name="duration" class="form-control" required>
                            <select class="form-select select2" id="duration_type" name="duration_type" required>
...
<script>
    ...
    $(document).on('click', '.add-modal', function (e) {
        ...
        $('#save-btn').text('Save');
        $('#create_modal .modal-title').text('Add Warranty');
    ...
    $(document).ready(function () {
        $('#save-btn').on('click', function (e) {
            ...
            let url = isEdit 
                ? "{{ url('warranties') }}/" + pramId 
                : "{{ route('warranties.store') }}";
