...
<div class="main-content app-content mt-0">
        ...
        <div class="main-container container-fluid">
            <div class="row mt-6 mb-4">
                <div class="col-12 text-end" style="display: flex; justify-content: end">
                    <button class="btn custom-create-edit-btn btn-primary fw-bold rounded-2 shadow-sm px-5 py-2 d-flex align-items-center category-modal" type="button" data-bs-toggle="modal" data-bs-target="#create_create_modal">
                                            ...
                                            <table class="table dataTable no-footer" id="tableData">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-bolder">Category Name</th>
                                                        <th class="text-bolder">Category Code</th>
 ...
 <!-- { Modal } -->
 <div class="modal fade" id="create_create_modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <form class="form" id="form" action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        <label for="short_code" class="form-label fw-semibold">Category Code: </label>
                        <input class="form-control" type="text" id="short_code" name="short_code" value="{{ old('short_code') }}" placeholder="Enter short code" required>
                        <span>Category code is same as <strong>HSN code</strong></span>
                        @error('short_code')
                        <div class="text-danger mt-1">
                            <small><strong>{{ $message }}</strong></small>
                        </div>
                    ...
                    <div id="parent-data" class="row mt-3 d-none align-items-center">
                        <div class="mb-2">
                            <select class="form-select select2" id="parent_id" name="parent_id">
                                <option selected="selected" value="">Select parent category: </option>
                ...
                <div class="modal-footer">
                    ...
                    <a type="submit" class="btn btn-primary" id="category-btn">Save</a>
...
<script>
    ...
    $(function () {
        table = $('#tableData').DataTable({
            ...
            columns: [
                ...
                {data: 'short_code', name: 'short_code', className: 'fw-semibold'},
                {data: 'description', name: 'description', className: 'fw-semibold text-center'},
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const fields = document.getElementById('parent-data');
    ...
    $(document).on('click', '.category-modal', function (e) {
        ...
        $('#unit_create_modal .modal-title').text('Add Category');

        $('#parent_id').val('').trigger('change');
        $('#base-unit').val('').trigger('change');

        $('#parent-data').addClass('d-none');
        $('#flexCheckIndeterminate').prop('checked', false);
        $('#create_create_modal').modal('show');
    });
    ...
    $(document).on('click', '.edit-category', function (e) {
        ...
        $.get("{{ url('categories') }}/" + unitId + "/edit", function (data) {
            ...
            if (data.parent_id) {
                $('#parent-data').removeClass('d-none');
            ...
            $('#create_create_modal .modal-title').text('Edit Catgory');
            $('#category-btn').text('Update');
            $('#create_create_modal').modal('show');
        });
    });
    ...
    $(document).ready(function () {
        $('#category-btn').on('click', function (e) {
            ...
            $('#category-btn').addClass('d-none');
            $('#submit-loader').removeClass('d-none');

            const unitId = $('#category_id').val();
            const isEdit = unitId !== '';
            ...
            if (isEdit) {
                ...
                $('#create_create_modal .modal-title').text('Add Catgory');
            }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#create_create_modal').modal('hide');
